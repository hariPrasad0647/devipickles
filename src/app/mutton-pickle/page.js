...
const WEIGHT_OPTIONS = [
  { id: "250g", label: "250gm", price: 599, img: "/images/offers/2.png" },
  { id: "500g", label: "500gm", price: 1199, img: "/images/offers/2.png" },
  { id: "1kg", label: "1kg", price: 2000, img: "/images/offers/2.png" },
];
  ...
  async function startRazorpayCheckout(customerData) {
    ...
    try {
      ...
      const options = {
        ...
        name: "Devi Foods",
        description: `Devi Spicy Mutton Pickle (${selectedWeight?.label}, ${pack})`,
        order_id: order.id,
        prefill: {
  ...
  return (
    <>
      <section
        ...
        aria-label="Order Devi Spicy Mutton Pickle"
        style={{
          background:
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              ...
              <div className="mt-4 grid grid-cols-4 gap-3">
                {THUMB_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Mutton pickle view ${index + 1}`}
                      className="w-full h-full object-cover"
                    />
                  </button>
                ))}
            ...
            <div className="space-y-6">
              ...
              <div className="text-sm leading-relaxed text-gray-700">
                Our boneless Mutton pickle is slow-cooked in{" "}
