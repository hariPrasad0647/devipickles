      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 pb-6 lg:pt-14 lg:pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
              <li>
                <Link href="#about" className="hover:text-[#FF3E3E] transition">
                  About Us
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-600">
              <li>
                Email:{" "}
                <a
                  href="mailto:support@devipickles.com"
                  className="hover:text-[#FF3E3E] transition"
                >
                  support@devipickles.com
                </a>
              </li>
              <li>WhatsApp: +91-98765-43210</li>
              <li>Timings: 10 AM – 7 PM IST</li>
              <li className="mt-2">
                <Link
                  href="#contact"
                  className="hover:text-[#FF3E3E] transition"
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-40">
          ...
          <div className="flex flex-wrap items-center gap-3 text-[11px] sm:text-xs text-gray-500">
            <Link href="/terms" className="hover:text-[#FF3E3E] transition">
              Terms & Conditions
            </Link>
