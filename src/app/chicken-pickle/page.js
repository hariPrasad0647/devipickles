...
const WEIGHT_OPTIONS = [
  { id: "250g", label: "250gm", price: 425, img: "/images/offers/2.png" },
...
export default function ProductOrderSection() {
  ...
  function handleAddToCart() {
    const payload = {
      productId: PRODUCTS.CHICKEN_PICKLE.id,
      name: PRODUCTS.CHICKEN_PICKLE.name,
  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-6">
          <Reviews productId={PRODUCTS.CHICKEN_PICKLE.id} />
        </div>
        <FAQs className="mt-8" />
        <Footer />
      </section >
